      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 rounded-lg p-8 md:p-12 mx-auto">
          <div className="mx-auto text-center max-w-5xl relative">
            ...
            <p className="text-base md:text-lg text-gray-900 mb-8 leading-relaxed relative z-10" style={{ marginTop: '5vh' }}>
            ...
            <p className="text-base text-gray-900 mb-8 relative z-10">
