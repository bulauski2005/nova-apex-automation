          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Our AI assistant guides you through each option to find the perfect fit for your practice.</p>
              </div>
            </div>
      ...
      <footer className="text-gray-900 py-12" style={{ backgroundColor: '#efefef' }}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="grid grid-cols-1 md:grid-cols-4 items-center text-gray-600 text-sm gap-4">
              <p className="md:col-span-3">&copy; 2024 Novapex Automation. All rights reserved.</p>
