        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 bg-white/80 rounded-lg p-8 md:p-12 mx-auto">
          <div className="mx-auto text-center max-w-5xl">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed" style={{ marginTop: '5vh' }}>
              AI-powered automation for every stage of your practice operations—from administrative workflows and real-time patient communication to web lead engagement, automated scheduling, missed-call recovery, and smart NLP-driven follow-ups and reminders.
            </p>
