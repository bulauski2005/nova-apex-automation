        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="relative p-8 border border-gray-200 hover:shadow-lg transition-shadow flex flex-col">
              ...
              <p className="text-gray-600 mb-6" style={{ fontSize: '15px' }}>Perfect for solo practices looking to capture every lead and automate patient communication.</p>
              <div className="mb-6">
            ...
            <Card className="relative p-8 hover:shadow-lg transition-shadow flex flex-col transform md:scale-105" style={{ borderWidth: '2px', borderColor: 'var(--accent)' }}>
              ...
              <p className="text-gray-600 mb-6" style={{ fontSize: '15px' }}>Our most popular solution for practices ready to automate the front desk and increase booked appointments.</p>
              <div className="mb-6">
            ...
            <Card className="relative p-8 border border-gray-200 hover:shadow-lg transition-shadow flex flex-col">
              ...
              <p className="text-gray-600 mb-6" style={{ fontSize: '15px' }}>Complete AI-powered patient acquisition and communication system for high-volume and multi-location practices.</p>
              <div className="mb-6">
