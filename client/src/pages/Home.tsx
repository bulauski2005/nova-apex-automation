...
export default function Home() {
  ...
  const exportImplementationData = () => {
    ...
    const content = `NOVAPEX - IMPLEMENTATION QUESTIONNAIRE
${'='.repeat(50)}
...
Please review and confirm all details are accurate.`;
  ...
  return (
    <div className="min-h-screen bg-[#01040c]">
      {/* Navigation */}
      <nav
        className="sticky top-0 z-50 backdrop-blur-2xl border-b border-white/[0.06] bg-[#01040c]/40 shadow-[0_8px_30px_rgba(0,0,0,0.35)]"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <div className="flex items-center space-x-2 flex-1">
              ...
              <span className="font-semibold" style={{ color: '#ffffff', fontFamily: 'Montserrat, sans-serif', fontSize: '14px' }}>
                NOVAPEX AI
              </span>
            </div>
            ...
            <div className="flex justify-end items-center space-x-2 flex-1">
              <div className="hidden md:block">
                <a
                  href="#contact"
                  style={{ backgroundColor: '#5FE1EE', color: '#ffffff' }}
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#07111d] via-[#01040c] to-[#080c1b]" />
        ...
        <div className="absolute top-1/3 -left-32 h-[26rem] w-[26rem] rounded-full bg-[#8b5cf6]/25 blur-3xl hero-ambient-2" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-card p-6 rounded-lg border border-[#1e2d45] hover:shadow-[0_8px_30px_rgba(37,99,235,0.15)] hover:border-[#3b82f6]/40 transition-all">
              <div className="w-12 h-12 rounded-md flex items-center justify-center mb-4" style={{ backgroundColor: '#5FE1EE', color: '#ffffff' }}>
      ...
      {/* Services Section */}
      <section id="services" className="py-20 md:py-32 bg-[#030915] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card id="feature-admin" className="p-8 scroll-mt-24 hover:shadow-lg transition-shadow border border-[#1e2d45]">
              <div className="w-12 h-12 rounded-md flex items-center justify-center mb-6" style={{ backgroundColor: '#5FE1EE', color: '#ffffff' }}>
      ...
      <section className="py-20 md:py-32 bg-[#030915] relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-md" style={{ backgroundColor: '#5FE1EE', color: '#ffffff' }}>
      ...
      {/* About Us Section */}
      <section id="about" className="py-20 md:py-32 bg-[#040d19] relative overflow-hidden">
        <div className="absolute top-0 left-0 h-80 w-80 rounded-full bg-[#8b5cf6]/20 blur-3xl" />
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 md:py-32 bg-[#030915] relative overflow-hidden">
        <div className="absolute -top-24 left-1/4 h-96 w-96 rounded-full bg-[#8b5cf6]/20 blur-3xl" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="relative p-8 border border-[#1e2d45] hover:shadow-lg transition-shadow flex flex-col">
              ...
              <Button style={{ backgroundColor: '#5FE1EE', color: '#ffffff' }} className="w-full mb-8 font-bold accent-button-hover rounded-full" onClick={() => window.location.href = 'https://buy.stripe.com/6oU6oHeIG9Iz3RG7Wb04800'}>
                Get Started
              </Button>
            ...
            <Card className="relative p-8 hover:shadow-lg transition-shadow flex flex-col transform md:scale-105" style={{ borderWidth: '2px', borderColor: '#5FE1EE' }}>
              ...
              <Button style={{ backgroundColor: '#5FE1EE', color: '#ffffff' }} className="w-full font-bold accent-button-hover mb-8 rounded-full" onClick={() => window.location.href = 'https://buy.stripe.com/bJe00j1VUaMD1Jy6S704801'}>
                Get Started
              </Button>
              <div className="space-y-3 flex-grow text-sm">
            ...
            <Card className="relative p-8 border border-[#1e2d45] hover:shadow-lg transition-shadow flex flex-col">
              ...
              <Button style={{ backgroundColor: '#5FE1EE', color: '#ffffff' }} className="w-full mb-8 font-bold accent-button-hover rounded-full" onClick={() => window.location.href = 'https://buy.stripe.com/9B6cN56ca5sj5ZOfoD04802'}>
                Get Started
              </Button>
              <div className="space-y-3 flex-grow text-sm">
