        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-card p-6 rounded-lg border border-[#1e2d45] hover:shadow-[0_8px_30px_rgba(37,99,235,0.15)] hover:border-[#3b82f6]/40 transition-all">
              <div className="w-12 h-12 rounded-md flex items-center justify-center mb-4" style={{ backgroundColor: '#5FE1EE', color: '#0a1420' }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card id="feature-admin" className="p-8 scroll-mt-24 hover:shadow-lg transition-shadow border border-[#1e2d45]">
              <div className="w-12 h-12 rounded-md flex items-center justify-center mb-6" style={{ backgroundColor: '#5FE1EE', color: '#0a1420' }}>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-md" style={{ backgroundColor: '#5FE1EE', color: '#0a1420' }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="relative p-8 border border-[#1e2d45] hover:shadow-lg transition-shadow flex flex-col">
              ...
              <Button style={{ backgroundColor: '#5FE1EE', color: '#0a1420' }} className="w-full mb-8 font-bold accent-button-hover rounded-full" onClick={() => window.location.href = 'https://buy.stripe.com/6oU6oHeIG9Iz3RG7Wb04800'}>
                Get Started
              </Button>
            ...
            <Card className="relative p-8 hover:shadow-lg transition-shadow flex flex-col transform md:scale-105" style={{ borderWidth: '2px', borderColor: '#5FE1EE' }}>
              ...
              <Button style={{ backgroundColor: '#5FE1EE', color: '#0a1420' }} className="w-full font-bold accent-button-hover mb-8 rounded-full" onClick={() => window.location.href = 'https://buy.stripe.com/bJe00j1VUaMD1Jy6S704801'}>
                Get Started
              </Button>
              <div className="space-y-3 flex-grow text-sm">
            ...
            <Card className="relative p-8 border border-[#1e2d45] hover:shadow-lg transition-shadow flex flex-col">
              ...
              <Button style={{ backgroundColor: '#5FE1EE', color: '#0a1420' }} className="w-full mb-8 font-bold accent-button-hover rounded-full" onClick={() => window.location.href = 'https://buy.stripe.com/9B6cN56ca5sj5ZOfoD04802'}>
                Get Started
              </Button>
              <div className="space-y-3 flex-grow text-sm">
