  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden pb-4 border-t border-gray-100">
              <button
                type="button"
                onClick={() => scrollToSection("home")}
                className="block w-full text-left px-4 py-2 text-gray-700 hover:text-[#5FE1EE] hover:bg-gray-50 bg-transparent border-0"
              >
                Home
              </button>
              <button
      ...
      >
        ...
        <div className="absolute -bottom-8 inset-x-0 h-48 bg-gradient-to-t from-[#5FE1EE]/15 via-[#5FE1EE]/5 to-transparent" />
      ...
      <section id="pricing" className="py-20 md:py-32 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-base md:text-lg text-gray-900 max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="relative p-8 border border-gray-200 hover:shadow-lg transition-shadow flex flex-col">
              ...
              <p className="text-gray-900 mb-6 font-bold" style={{ fontSize: '14px' }}>Perfect for solo practices looking to capture every lead and automate patient communication.</p>
              <div className="mb-6">
            ...
            <Card className="relative p-8 hover:shadow-lg transition-shadow flex flex-col transform md:scale-105" style={{ borderWidth: '2px', borderColor: 'var(--accent)' }}>
              ...
              <p className="text-gray-900 mb-6 font-bold" style={{ fontSize: '14px' }}>Our most popular solution for practices ready to automate the front desk and increase booked appointments.</p>
              <div className="mb-6">
            ...
            <Card className="relative p-8 border border-gray-200 hover:shadow-lg transition-shadow flex flex-col">
              ...
              <p className="text-gray-900 mb-6 font-bold" style={{ fontSize: '14px' }}>Complete AI-powered patient acquisition and communication system for high-volume and multi-location practices.</p>
              <div className="mb-6">
