  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex items-center h-16">
            ...
            <div className="hidden md:flex items-center justify-center gap-x-6 lg:gap-x-8">
              <button
                ...
                className="transition-colors font-medium text-[#001a4d] hover:text-[#5FE1EE] cursor-pointer p-0 bg-transparent border-0 nav-link"
              >
                Home
              </button>
              <button
      ...
      >
        ...
        <div className="absolute -bottom-8 inset-x-0 h-48 bg-gradient-to-t from-[#5FE1EE]/60 via-[#5FE1EE]/25 to-transparent" />
              ...
              <div className="relative mx-auto max-w-lg lg:max-w-none">
                ...
                <div className="relative overflow-hidden rounded-[2rem] border border-white/70 shadow-2xl shadow-[#001a4d]/10 backdrop-blur-sm">
                  <img
                    ...
                    className="h-[20rem] md:h-[28rem] w-full object-cover object-center"
                  />
                ...
                <div className="absolute -top-7 left-6 md:left-10 glass-surface rounded-full px-4 py-2 shadow-lg border border-white/70 flex items-center gap-2">
                  ...
                  <span className="text-[11px] md:text-xs text-gray-700 font-semibold">Trusted by Dental Practices</span>
                </div>
              </div>
            </div>
          </div>
