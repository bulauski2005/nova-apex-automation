  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow">
        ...
        <section className="mb-4">
          <h2 className="font-semibold mb-2">2. Using the Services</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-4">
          <h2 className="font-semibold mb-2">3. Services and Payments</h2>
          <p className="text-gray-700">
        ...
        <section className="mb-4">
          ...
          <p className="text-gray-700">
            ...
            IN CONNECTION WITH THE SERVICES, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            OUR AGGREGATE LIABILITY ARISING OUT OF OR RELATED TO THESE TERMS WILL NOT EXCEED THE
            AMOUNTS PAID BY YOU TO NOVAPEX IN THE TWELVE (12) MONTHS PRECEDING THE EVENT GIVING
            RISE TO LIABILITY.
          </p>
        </section>
        ...
        <section className="mb-4">
          ...
          <p className="text-gray-700">
            ...
            remain responsible for any amounts owed through the date of termination.
          </p>
        </section>
        ...
        <section className="mb-4">
          ...
          <p className="text-gray-700">
            ...
            Terms will be resolved in the state or federal courts located in Florida.
          </p>
        </section>

        <section className="mb-6">
          <h2 className="font-semibold mb-2">12. Changes to Terms</h2>
          <p className="text-gray-700">
